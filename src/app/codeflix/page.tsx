  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.textContent}>
          <img className='z-10' src="/img/logo.png" alt="logoCodeflix" />
          ...
          <div className='flex gap-3'>
              <Link href="https://github.com/gabrielspessanha/codeflix-Backend" target='__blank'>
                <button className='cursor-pointer text-white bg-gradient-to-r from-violet-900 to-cyan-950 border-none py-2 ease-out duration-300 rounded-md hover:scale-110' style={{ border: 'none', width: '10rem'}}>Back-end</button>
              </Link>

              <Link href="https://github.com/gabrielspessanha/codeflix-frontEnd" target='__blank'>
                <button className='text-white bg-gradient-to-r from-amber-400 to-amber-500 border-none py-2 ease-out duration-300 rounded-md hover:scale-110' style={{ border: 'none', width: '10rem'}}>Front-end</button>
              </Link>
          </div>
          <video 
          src='/video/codeflixVideo.mp4'
          controls
          className={styles.video}
          poster='/video/capaVideo.png'
        >
